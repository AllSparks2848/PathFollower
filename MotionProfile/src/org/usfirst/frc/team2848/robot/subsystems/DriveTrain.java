...
import org.usfirst.frc.team2848.robot.constants.ElectricalConstants;
...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
	leftFront = new Spark(ElectricalConstants.DRIVE_LEFT_FRONT);
	leftBack = new Spark(ElectricalConstants.DRIVE_LEFT_BACK);
	rightFront = new Spark(ElectricalConstants.DRIVE_RIGHT_FRONT);
	rightBack = new Spark(ElectricalConstants.DRIVE_RIGHT_BACK);
